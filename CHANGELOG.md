...
来自实跑诊断（worker task 被主窗口直接做，而非 dispatch 给 sub-agent）。dogfood 痕迹：`.enloom/2026-07-06-enloom-v06/`。
...
来自对 enloom v0.4 的 dev-wiki knowledge-base 交叉评审，三轴裁决（机制对 / 框架对 / 时机对）。dogfood 痕迹：`.enloom/2026-07-01-enloom-v05/`，设计输入 `design/_archive/2026-07-01-enloom-v0.5-optimization-design.md`。

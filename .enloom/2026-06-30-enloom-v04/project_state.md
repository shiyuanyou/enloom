...
**Phase: P2 引用层完成,待 P3** — eval-guide 2 处裸路径修复,全包裸 `.enloom/runs` 归零。B 组其余文件用相对路径形态确认正确,不需改。
...
- P3(产物层 C 组)待办:README 目录树 + "Two directories" 表更新 / PROGRESS v0.4 条目 / 旧 dogfood 冻结确认 / 全局重装 enloom skill。

...
`triage` is a sub-action of lifecycle **Stage 0** (见 [workflow-steps.md](workflow-steps.md))。本契约仍是 `triage` 的判断依据。具体 worked examples 见 [examples/triage-decision-tree.md](examples/triage-decision-tree.md)。本文件定义「为什么」,那一份定义「怎么做」。
